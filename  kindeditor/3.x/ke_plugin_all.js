...
KE.plugin['bold'] = {
	...
	'click' : function(textareaName)
	{
		KE.editor[textareaName].iframeDoc.execCommand('bold', false, null);
	}
};
KE.plugin['bgcolor'] = {
	'icon'				: 'bgcolor.gif',
...
KE.plugin['copy'] = {
	...
	'click' : function(textareaName)
	{
		KE.editor[textareaName].iframeDoc.execCommand('copy', false, null);
	}
};
KE.plugin['cut'] = {
	'icon'	: 'cut.gif',
	...
	'click' : function(textareaName)
	{
		KE.editor[textareaName].iframeDoc.execCommand('cut', false, null);
	}
};
KE.plugin['date'] = {
	'icon'	: 'date.gif',
...
KE.plugin['indent'] = {
	...
	'click' : function(textareaName)
	{
		KE.editor[textareaName].iframeDoc.execCommand('indent', false, null);
	}
};
KE.plugin['italic'] = {
	'icon'	: 'italic.gif',
	...
	'click' : function(textareaName)
	{
		KE.editor[textareaName].iframeDoc.execCommand('italic', false, null);
	}
};
KE.plugin['justifycenter'] = {
	...
	'click' : function(textareaName)
	{
		KE.editor[textareaName].iframeDoc.execCommand('justifycenter', false, null);
	}
};
KE.plugin['justifyfull'] = {
	...
	'click' : function(textareaName)
	{
		KE.editor[textareaName].iframeDoc.execCommand('justifyfull', false, null);
	}
};
KE.plugin['justifyleft'] = {
	...
	'click' : function(textareaName)
	{
		KE.editor[textareaName].iframeDoc.execCommand('justifyleft', false, null);
	}
};
KE.plugin['justifyright'] = {
	...
	'click' : function(textareaName)
	{
		KE.editor[textareaName].iframeDoc.execCommand('justifyright', false, null);
	}
};
KE.plugin['numberedlist'] = {
	...
	'click' : function(textareaName)
	{
		KE.editor[textareaName].iframeDoc.execCommand('insertorderedlist', false, null);
	}
};
KE.plugin['outdent'] = {
	'icon'	: 'outdent.gif',
	...
	'click' : function(textareaName)
	{
		KE.editor[textareaName].iframeDoc.execCommand('outdent', false, null);
	}
};
KE.plugin['paste'] = {
	'icon'	: 'paste.gif',
	...
	'click' : function(textareaName)
	{
		KE.editor[textareaName].iframeDoc.execCommand('paste', false, null);
	}
};
KE.plugin['preview'] = {
	'icon'	: 'preview.gif',
...
KE.plugin['print'] = {
	...
	'click' : function(textareaName)
	{
		KE.editor[textareaName].iframeDoc.execCommand('print', false, null);
	}
};
KE.plugin['redo'] = {
	'icon'	: 'redo.gif',
	...
	'click' : function(textareaName)
	{
		KE.editor[textareaName].iframeDoc.execCommand('redo', false, null);
	}
};
KE.plugin['removeformat'] = {
	...
	'click' : function(textareaName)
	{
		KE.editor[textareaName].iframeDoc.execCommand('removeformat', false, null);
	}
};
KE.plugin['selectall'] = {
	'icon'	: 'selectall.gif',
	...
	'click' : function(textareaName)
	{
		KE.editor[textareaName].iframeDoc.execCommand('selectall', false, null);
	}
};
KE.plugin['source'] = {
	'icon'	: 'source.gif',
...
KE.plugin['strikethrough'] = {
	...
	'click' : function(textareaName)
	{
		KE.editor[textareaName].iframeDoc.execCommand('strikethrough', false, null);
	}
};
KE.plugin['subscript'] = {
	'icon'	: 'subscript.gif',
	...
	'click' : function(textareaName)
	{
		KE.editor[textareaName].iframeDoc.execCommand('subscript', false, null);
	}
};
KE.plugin['superscript'] = {
	...
	'click' : function(textareaName)
	{
		KE.editor[textareaName].iframeDoc.execCommand('superscript', false, null);
	}
};
KE.plugin['textcolor'] = {
	'icon'				: 'textcolor.gif',
...
KE.plugin['underline'] = {
	...
	'click' : function(textareaName)
	{
		KE.editor[textareaName].iframeDoc.execCommand('underline', false, null);
	}
};
KE.plugin['undo'] = {
	'icon'	: 'undo.gif',
	...
	'click' : function(textareaName)
	{
		KE.editor[textareaName].iframeDoc.execCommand('undo', false, null);
	}
};
KE.plugin['unlink'] = {
	'icon'	: 'unlink.gif',
	...
	'click' : function(textareaName)
	{
		KE.editor[textareaName].iframeDoc.execCommand('unlink', false, null);
	}
};
KE.plugin['unorderedlist'] = {
	...
	'click' : function(textareaName)
	{
		KE.editor[textareaName].iframeDoc.execCommand('insertunorderedlist', false, null);
	}
};
KE.plugin['zoom'] = {
